...
function ready(){
  ...
  Quas.fetch("https://www.reddit.com/r/DotA2/search.json?q=bug&sort=new&restrict_sr=on", "json")
  .then((res)=>{
  ...
  render(){
    ...
    return (
      #<a .post-con href="{this.props.url}" target="_blank">
        ...
        <div .post-thumbnail>
          <div .img-con>
            <img src="/heroes/npc_dota_hero_weaver.png">
          </div>
  ...
  render(){
    return (
      #<nav>
        ...
        <div .nav-link>
          <a href="https://twitter.com/PohkaDota">
          ...
          <a href="https://github.com/pohka/dota-bug-tracker">
